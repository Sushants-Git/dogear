...
export const ImportIcon = (p) => (
  <Icon {...p}><path d="M12 15V4M8 8l4-4 4 4M4 17v2a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-2" /></Icon>
)
...
export const RefreshIcon = (p) => (
  <Icon {...p}><path d="M20 12a8 8 0 1 1-2.3-5.6M20 4v5h-5" /></Icon>
)

export const StopIcon = (p) => (
  <Icon {...p}><rect x="7" y="7" width="10" height="10" rx="2" /></Icon>
)


/*
 * The X mark — the one thing in here that is a logo rather than an icon, so it is
 * solid, off the stroke grid, and drawn to its own proportions. Everything else follows
 * one weight; a logo redrawn to match the set stops being the logo.
 */
export const XIcon = ({ size = 16, ...rest }) => (
